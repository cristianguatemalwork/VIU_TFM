...
\usepackage[colorlinks = true, linkcolor = black, urlcolor = naranja, citecolor = green,
...
\fancyhead{}
\fancyfoot{}
\fancyfoot[R]{{\scriptsize\thepage\ de \pageref{LastPage} | Detección de aportaciones fraudentas en el Instituto Ecuatoriano de Seguridad Social}}

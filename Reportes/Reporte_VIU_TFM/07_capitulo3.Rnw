...
A partir de esta estructura, se pueden calcular diversas métricas que describen la capacidad predictiva del modelo y dependiendo de nuestros objetivos se deberá optar por la métrica más adecuada. Entre las mismas tenemos:

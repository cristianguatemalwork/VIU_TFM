...
Según \textcite{FAWCETT2006861}, una de las herramientas más comunes para evaluar el rendimiento de un modelo de clasificación, es la matriz de confusión. La misma tiene como objetivo medir el funcionamiento de un algoritmo comparando los valores reales con los resultados obtenidos con el mismo, donde los resultados pueden formar parte de cuatro categorías:

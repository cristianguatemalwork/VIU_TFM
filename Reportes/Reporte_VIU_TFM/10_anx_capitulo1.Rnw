...
El acceso a los scripts que generaron esta información es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_clean_data.ipynb}{click aquí}.
...
El acceso a los scripts que generaron todo el desarrollo y resultados del algoritmo del clúster jerárquico es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_cluster_jerarquico.ipynb}{click aquí}.
...
El acceso a los scripts que generaron todo el desarrollo y resultados del algoritmo de K-Means es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_k_means.ipynb}{click aquí}.
...
El acceso a los scripts que generaron todo el desarrollo y resultados del algoritmo de DBSCAN es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_dbscan.ipynb}{click aquí}.
...
El acceso a los scripts que generaron todo el proceso de limpieza de datos antes del aprendizaje supervisado es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_analisis_atipicos.ipynb}{click aquí}.

El acceso a los scripts que generaron todo el proceso de transformación de datos antes del aprendizaje supervisado es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_prepacion_data.ipynb}{click aquí}.
...
El acceso a los scripts que generaron toda la implementación del algoritmo KNN es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_knn.ipynb}{click aquí}.
...
El acceso a los scripts que generaron toda la implementación de los árboles simples es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_arboles.ipynb}{click aquí}.
...
El acceso a los scripts que generaron toda la implementación del conjunto de modelos es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_arboles.ipynb}{click aquí}.
...
El acceso a los scripts que generaron toda la implementación de XGBoost para clasificación es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_otras_tecnicas.ipynb}{click aquí}.
...
El acceso a los scripts que generaron toda la implementación de redes neuronales para clasificación es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_otras_tecnicas.ipynb}{click aquí}.

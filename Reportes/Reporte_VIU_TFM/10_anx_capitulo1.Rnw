...
No se hace un análisis detallado por cada tabla del esquema, pues ampliaría innecesariamente la longitud del presente documento. Es por ello que, en los cuadros \ref{tab:info_KSPCOTEMPTIP}, \ref{tab:info_KSRECTPLADET}, \ref{tab:info_KSRECTPLANILLAS}, \ref{tab:info_KSPCOTREGCIV} , \ref{tab:info_PRESTACIONES}, \ref{tab:info_BENEFICIARIOS}, \ref{tab:info_ROL_PERIODO} y \ref{tab:info_KSMIGTAPORTES} se plasma una descripción general del contenido y la estructura de cada una de ellas.

Ahora bien, las tablas presentadas anteriormente son independientes entre sí, por lo que necesitan integrarse de manera conjunta para tener  información consolidada y alcanzar el objetivo planteado. El código \textit{.sql} empleado proporciona los atributos necesarios para la obtención de la información inicial, misma que se someterá al proceso KDD. Se accede a los scripts que generaron esta información haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/tree/main/SQL/TFM}{clic aquí}
...
El acceso a los scripts que generaron esta información es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_clean_data.ipynb}{clic aquí}.

\section{Algoritmos de clúster jerárquico} \label{sec:alg_clus_jear}

La implementación del algoritmo de clúster jerárquico para la identificación de atípico se basa en el siguiente código:
...
\subsection{Ejemplos de la clasificación y correcciones}
...
\begin{figure}[H]  
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.23]{graficos/algoritmo_cj_20013447_2.png} 
    \end{minipage}
    \hspace{0.06\textwidth} 
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.23]{graficos/algoritmo_cj_20013447_3.png} 
    \end{minipage}
    \vfill  %
    \hspace{-0.06\textwidth} 
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.23]{graficos/algoritmo_cj_3608_2.png} 
    \end{minipage}
    \hspace{0.06\textwidth} 
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.23]{graficos/algoritmo_cj_3608_3.png} 
    \end{minipage}
  ...
  \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.23]{graficos/algoritmo_cj_135752_2.png} 
    \end{minipage}
    \hspace{0.06\textwidth} 
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.23]{graficos/algoritmo_cj_135752_3.png}  
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.23]{graficos/algoritmo_cj_154409_2.png}  
    \end{minipage}
    \hspace{0.06\textwidth} 
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[scale=0.23]{graficos/algoritmo_cj_154409_3.png}  
    \end{minipage}

\caption{\headlinecolor{\underline{Ejemplos de la aplicación del CJ y su correción-Anexos }}}
\label{fig:algoritmo_cj_depu_anex}  
    
\end{figure}


El acceso a los scripts que generaron todo el desarrollo y resultados del algoritmo del clúster jerárquico es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_cluster_jerarquico.ipynb}{clic aquí}.


\section{Algoritmos de K-Means} \label{sec:alg_kmean}

La implementación del algoritmo de K-Means para la identificación de atípico se basa en el siguiente código:
...
El acceso a los scripts que generaron todo el desarrollo y resultados del algoritmo de K-Means es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_k_means.ipynb}{clic aquí}.

\section{Algoritmos DBSCAN} \label{sec:alg_dbscan}

La implementación del algoritmo DBSCAN para la identificación de atípico se basa en el siguiente código:
...
El acceso a los scripts que generaron todo el desarrollo y resultados del algoritmo de DBSCAN es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_dbscan.ipynb}{clic aquí}.

\section{Limpieza de datos antes del aprendizaje supervisado} \label{sec:limpieza_datos_super}

\subsection{Para la información pensional}
...
El acceso a los scripts que generaron todo el proceso de limpieza de datos antes del aprendizaje supervisado es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_analisis_atipicos.ipynb}{clic aquí}.

El acceso a los scripts que generaron todo el proceso de transformación de datos antes del aprendizaje supervisado es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_prepacion_data.ipynb}{clic aquí}.

\section{Algoritmo KNN} \label{sec_anexos:knn}

La implementación de la validación cruzada para el algoritmo KNN  se basa en el siguiente código:
...
El acceso a los scripts que generaron toda la implementación del algoritmo KNN es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_knn.ipynb}{clic aquí}.

\section{Algoritmo de árboles} \label{sec_anexos:arboles}

La implementación de la validación cruzada para la técnica de árboles simples se basa en el siguiente código:
...
El acceso a los scripts que generaron toda la implementación de los árboles simples es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_arboles.ipynb}{clic aquí}.
...
Búsqueda de hiperparámetros por RandomizedSearchCV
...
El acceso a los scripts que generaron toda la implementación del conjunto de modelos es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_arboles.ipynb}{clic aquí}.

\section{XGBClassifier}  \label{sec_anexos:conjunto_modelos_XGBClassifier}
...
El acceso a los scripts que generaron toda la implementación de XGBoost para clasificación es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_otras_tecnicas.ipynb}{clic aquí}.

\section{Redes neuronales}  \label{sec_anexos:conjunto_modelos_redes}
...
Búsqueda de hiperparámetros por GridSearchCV con un balanceo de clases
...
El acceso a los scripts que generaron toda la implementación de redes neuronales para clasificación es haciendo \href{https://github.com/cristianguatemalwork/VIU_TFM/blob/main/Python/TFM/VIU_ml_otras_tecnicas.ipynb}{clic aquí}.

...
\caption{\headlinecolor{\underline{Matriz de confusión para el algortimo del arbol simple balanaceado}}}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.35]{graficos/confusion_matrix_algoritmo_AdaBoostClassifier_grid_search.png}
\caption{\headlinecolor{\underline{Matriz de confusión para el algortimo con GridSearchCV}}}
...
\caption{\headlinecolor{\underline{Matriz de confusión para el algortimo con RandomSearchCV}}}
...
\caption{\headlinecolor{\underline{Matriz de confusión para el algortimo balanceado con GridSearchCV}}}

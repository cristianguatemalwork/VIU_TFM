...
la carpeta \textit{Python} que contiene los scripts .ipynb, la carpeta \textit{SQL} con los script .sql y la carpeta \textit{R} contiene los scrip .R utilizados en la edición del presente proyecto en formato \texttt{\LaTeX}.

...
Por otro lado, al realizar la búsqueda de los parámetros anteriores en la cuadrícula descrita en la subsección \ref{sec_anexos:conjunto_modelos_XGBClassifier} mediante  GridSearchCV, los parámetros óptimos son:

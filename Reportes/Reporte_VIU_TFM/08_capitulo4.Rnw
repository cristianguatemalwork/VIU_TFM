...
En primera instancia, se crea una variable adicional que es \tetxit{IMPO\_2023}, misma que contiene la información del número de imposiciones calculadas de los pensionitas.

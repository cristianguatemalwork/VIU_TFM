...
\caption{\headlinecolor{\underline{Resultados de la aplicaicón del cluster jerárquico }}}
...
Otro algoritmo que tiene gran potencial para estimar valores atípicos es el k-means. En este sentido

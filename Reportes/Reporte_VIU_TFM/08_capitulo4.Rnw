...
Para contrastar este resultado y evaluar el modelo, se obtiene la matriz de confusión que se presenta en en el cuadro \ref{tab:mc_knn_2} y en la figura \ref{fig:matriz_conf_knn_bal_acp} en anexos.
